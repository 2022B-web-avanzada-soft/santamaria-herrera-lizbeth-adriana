        ...
        socket.emit(
            ...
            (datosEventoHola) => { // Callback o respuesta del evefnto
                ...
                //SET ARREGLO
                    ...
                    // setArreglo([1,2,3]) //Metodo #1: SIN CALLBACK
                    //setArreglo(([1.2]) = > [...[1,2],3]) => [1,2,3] //Metodo #2: con CALLBACK
                        //Las dos formas hacen los mismo, pero el callback es en casos especiales
                setMensajes((mensajesAnteriores) => [...mensajesAnteriores, nuevoMensaje]);
            }
        )
    }
