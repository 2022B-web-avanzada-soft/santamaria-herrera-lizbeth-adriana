...
let AutoService = class AutoService {
    constructor(datasource) {
        ...
        this.autoRepository = this.datasource.getRepository(auto_entity_1.AutoEntity);
    }
    find(opciones) {
    ...
    update(datosActualizar, id) {
        return this.autoRepository.save(Object.assign(Object.assign({}, datosActualizar), { id }));
    }
    delete(id) {
